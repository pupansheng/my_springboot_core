...
public class DbFilterExecutorUtil {
    ...
    public static Map<String, Object> getAdditionalParameter(BoundSql boundSql) {
        try {
            ...
            throw new RuntimeException("获取 BoundSql 属性值 additionalParameters 失败: " + var2, var2);
        }
    }
    ...
    static {
        try {
            ...
            throw new RuntimeException("获取 BoundSql 属性 additionalParameters 失败: " + var1, var1);
        }
    }
}
