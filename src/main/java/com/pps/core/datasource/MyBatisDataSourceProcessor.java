...
import com.pps.core.mymaperscan.MyClassPathMapperScanner;
...
public class MyBatisDataSourceProcessor implements ImportBeanDefinitionRegistrar, EnvironmentAware {
     ...
     * 框架默认的mapper位置
     */
    private final String DEFUALT_FREAME_MAPPER_LOCATION="com.pps.core.authority.security.mapper";
        ...
        if (ValidateUtil.isNotEmpty(dataSourceList)) {
            ...
            for (String dataSourseName : dataSourses) {
                ...
                //配置sessiong工厂
                {
                    ...
                    registerBean(beanDefinitionRegistry, dataSourseName + "SqlSessionFactory", this.buildSqlSessionFactoryBean(binder, dataSourseName, baseSourceConfig), MybatisSqlSessionFactoryBean.class,isFirst);
    ...
    private void registerMapper(BeanDefinitionRegistry beanDefinitionRegistry, BaseSourceConfig baseSourceConfig, String dataSourseName,String sessionFactoryName) {
        ...
        //添加默认的位置
        scanner.doScan(DEFUALT_FREAME_MAPPER_LOCATION);
        //配置的位置
