...
public class CompoentConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "mysecurity",name = "openVerifyCode",havingValue = "true")
    public ServletRegistrationBean indexServletRegistration() {



            ServletRegistrationBean registration = new ServletRegistrationBean(new VerifyServlet());
            registration.addUrlMappings(mySecurityProperty.getVerifyCodeUrl());
            log.info("已开启验证码校检 获取验证码url:{}",mySecurityProperty.getVerifyCodeUrl());
     ...
     class VerifyServlet extends HttpServlet {
         ...
         protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, java.io.IOException {
             ...
             session.setAttribute(mySecurityProperty.getValidateCodeParam(), randomCode.toString());
             // 禁止图像缓存。
